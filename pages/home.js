                            ...
                            <Row>
                                <Col className="col-md-12">
                                    <FormGroup>
                                        ...
                                        <Input className="form-control mr-sm-2" type="text" name="nomePet" id="nomePet" placeholder="Nome do Pet" />
                                    </FormGroup>
                                </Col>
                            </Row>
                            <Row>
                                <Col className="col-md-12">
                                    <FormGroup>
                                        ...
                                        <Input type="select" name="porte" id="porte">
                            ...
                            <Row>
                                <Col className="col-md-12">
                                    <FormGroup>
                                        ...
                                        <Input className="form-control mr-sm-2" type="text" name="endereco" id="endereco" placeholder="Endereço" />
                                    </FormGroup>
                                </Col>
                            </Row>
                            <Row>
